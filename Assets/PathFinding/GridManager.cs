...
public class GridManager : MonoBehaviour
{
    ...
    {
        Vector3 positionFormCoordinates = new Vector3();
        positionFormCoordinates.x = position.x * unityGridSize;
        positionFormCoordinates.z = position.y * unityGridSize;

        return positionFormCoordinates;
    }
